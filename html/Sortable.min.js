! function (t) {
    ...
    function I(t, e) {
        ...
        for (var o in R(e), this) '_' === o.charAt(0) && 'function' == typeof this[o] && (this[o] = this[o].bind(this));
    ...
    function P(t, e, n) {
        if (t) {
            ...
            } while (t = (o = (i = t).host) && o.nodeType ? o : i.parentNode)
        }
        var i, o;
        return null
    }
    ...
    return I.prototype = {
        ...
        _onDragOver: function (r) {
            ...
            if (void 0 !== r.preventDefault && (r.preventDefault(), !y.dragoverBubble && r.stopPropagation()), b = !0, p && !y.disabled && (C ? E || (f = !o.contains(t)) : g === this || p.checkPull(this, S, t, r) && T.checkPut(this, S, t, r)) && (void 0 === r.rootEl || r.rootEl === this.el)) {
                ...
                if (0 === D.children.length || D.children[0] === n || D === r.target && (v = r, _ = (m = D.lastElementChild).getBoundingClientRect(), s = (v.clientY - (_.top + _.height) > 5 || v.clientX - (_.right + _.width) > 5) && m)) {
                    if (s) {
